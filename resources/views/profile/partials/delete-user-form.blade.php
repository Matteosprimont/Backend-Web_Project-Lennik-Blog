<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Zodra je account is verwijderd, worden alle gegevens en bronnen permanent verwijderd. Download alle gegevens of informatie die je wilt behouden voordat je je account verwijdert.') }}
        </p>
    </header>
